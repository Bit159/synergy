...
<div id="loginBar_wrapper">
	<div id="loginBar" class="container">
		<sec:authorize access="isAnonymous()">
   			<a href="/synergy/all/joinForm">회원가입</a>
   			<a href="/synergy/all/loginForm">로그인</a> 
  		</sec:authorize>
  		
   		<sec:authorize access="isAuthenticated()">
   			<form action="/synergy/logout" method="post" name="logout">
   				<a href="javascript:document.logout.submit();">로그아웃</a>
   				<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }">
   			</form>
   			
   			<form action="/synergy/member/myPage" method="post" name="myPage">
...
<div id=header_wrapper>
	<header id="header" class="container">
		<!-- 로고 -->
		<div id="logo">
			<a href="/synergy/all/welcome"><img style="width:155px;height:55px;" src="../resources/image/logo.png"/></a>
		</div>
		<!-- nav -->
		<nav id="nav">
			<ul>
				<li class="welcome" style="white-space: nowrap;">
					<a href="/synergy/all/welcome">Welcome</a>
				</li>
				
				<li class="matching" style="white-space: nowrap;">
					<a href="/synergy/member/recruitGroup">스터디 매칭</a>
				</li>
				
				<li class="menu1" style="white-space: nowrap;">
					<a href="/synergy/member/createGroup">스터디 모집</a>
				</li>
				
				<li class="boardList" style="white-space: nowrap;">
					<a href="/synergy/all/boardList">게시판</a>
				</li>

...
<link rel="stylesheet" href="/resources/kkh1595/css/cardBoardView.css">
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
<script type="text/javascript" src="/resources/kkh1595/js/autolink.js"></script>
</head>
<body>
	<div class="body-wrapper">
	<jsp:include page="/WEB-INF/views/kkh1595/template/header.jsp"></jsp:include>
...
<!--                               <label class="reply_modify_label">댓글 수정</label> -->
		...
		<jsp:include page="/WEB-INF/views/kkh1595/template/footer.jsp"></jsp:include>
	</div>

...
<link rel="stylesheet" href="/resources/kkh/css/header.css">
<div id="loginBar_wrapper">
            <div id="loginBar" class="container">
            <a href="#">회원가입</a>
            <a href="/synergy-kh/all/loginForm">로그인</a> 
        </div>
        </div>
        <div id=header_wrapper>
			<header id="header" class="container">
                <!-- 로고 -->
				<div id="logo">
					<a href="/synergy-kh/all/welcome"><img alt="" style="width:155px;height:55px;" src="../resources/image/logo.png"/></a>
                </div>
                <!-- nav -->
				<nav id="nav">
					<ul>
						<li class="welcome" style="white-space: nowrap;">
							<a href="/synergy-kh/all/welcome">Welcome</a>
						</li>
						...
						<li class="freeBoard" style="white-space: nowrap;">
							<a href="#">게시판</a>
						</li>

...
<section class="join-form">
	...
	<form action="" method="post">
		...
		<div class="join-area">
			<input type="radio" name="gender" id="gender" value="남성" checked><span
				style="color: aliceblue">남 성</span>&emsp; <input type="radio"
				name="gender" id="gender" value="여성"><span
				style="color: aliceblue">여 성</span>
		</div>
		...
		<div class="join-area">
			<input type="date" id="birth" style="width: 45%;"> <label
				for="birth">BIRTH</label>
		</div>

...
<html>
  <head>
    ...
    <script async defer src="maptest.js"></script>
    <style>
      .info {
        position: relative;
        top: 5px;
...
<p>선택이 완료되었다면 완료 버튼을 눌러주세요<br><input type="button" value="완료" onclick="xydbclose()"></p>
<form>
...
function isCloseEnough(line1, line2, distance) {
  ...
  var result = false;
  if (parseFloat(line1) + parseFloat(line2) >= parseFloat(distance * 1000))
    result = true;
  return result;
}
</script> 
    <script
      ...
      src="//dapi.kakao.com/v2/maps/sdk.js?appkey=41be22a5170d5fc6115853c77dc3d45e"
    ></script>
    <script>
